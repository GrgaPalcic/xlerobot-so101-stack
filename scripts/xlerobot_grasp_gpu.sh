...
export GGCNN_PRIMARY_VIEW="${GGCNN_PRIMARY_VIEW:-overhead}"
export ASSOCIATION_PRIMARY_VIEW="${ASSOCIATION_PRIMARY_VIEW:-overhead}"
...
Environment="ASSOCIATION_PRIMARY_VIEW=${ASSOCIATION_PRIMARY_VIEW}"
